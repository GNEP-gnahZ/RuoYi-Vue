<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="customerList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="序号" align="center" prop="customerId" />
      <el-table-column label="客户地址" align="center" prop="customerAddress" />
      <el-table-column label="客户姓名" align="center" prop="customerName" />
      <el-table-column label="联系电话" align="center" prop="customerNumber" />
      <el-table-column label="备注" align="center" prop="customerRemarks" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="备注" prop="customerRemarks">
          <el-input v-model="form.customerRemarks" type="textarea" placeholder="请输入内容" />
        </el-form-item>
      </el-form>
